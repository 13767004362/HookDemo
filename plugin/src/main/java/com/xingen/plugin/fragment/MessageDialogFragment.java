...
public class MessageDialogFragment extends DialogFragment {
    ...
    public static void startDialog(AppCompatActivity activity) {
        MessageDialogFragment fragment = new MessageDialogFragment();
        fragment.show(activity.getSupportFragmentManager(), MessageDialogFragment.TAG);
    }
    ...
    public void onAttach(Context context) {
        ...
        final ContextThemeWrapper activityBase = (ContextThemeWrapper) getActivity().getBaseContext();
        final Context contextImpl = activityBase.getBaseContext();
        // 屏幕旋转，重建，可能导致 找不到当前的Fragment
        ContextImplHookManager.hookClassLoader(contextImpl, MessageDialogFragment.class.getClassLoader());
    }
